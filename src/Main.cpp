...
int main(){
	...
	// Texture
	Texture pyramidTex("Resources/planks.png", GL_TEXTURE_2D, 0, GL_RGBA, GL_UNSIGNED_BYTE);
	pyramidTex.texUnit(shaderProgram, "tex0", 0);
	Texture pyramidTexspec("Resources/planksSpec.png", GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE);
	pyramidTexspec.texUnit(shaderProgram, "tex1", 1);
